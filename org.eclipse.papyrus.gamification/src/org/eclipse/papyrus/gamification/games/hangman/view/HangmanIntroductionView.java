 ...
 *
 */
public class HangmanIntroductionView extends GameIntroductionView {
	 ...
	 */
	public HangmanIntroductionView(LevelContext levelContext, OnPlayerReadyItf onPlayerReadyItf, OnCancelGameItf onCancelGameItf) {
		super(levelContext, onPlayerReadyItf, onCancelGameItf);
	}

	@Override
	public String getHtmlPath() {
		return "/html/games/hangman/html/intro.html";
	}

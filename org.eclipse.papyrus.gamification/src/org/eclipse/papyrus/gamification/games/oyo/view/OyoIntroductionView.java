 ...
 *
 */
public class OyoIntroductionView extends GameIntroductionView {
	 ...
	 */
	public OyoIntroductionView(LevelContext levelContext, OnPlayerReadyItf onPlayerReadyItf, OnCancelGameItf onCancelGameItf) {
		super(levelContext, onPlayerReadyItf, onCancelGameItf);
	}

	@Override
	public String getHtmlPath() {
		return "/html/games/oyo/html/intro.html";
	}
